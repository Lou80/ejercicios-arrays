...
var bandas = ['El Kuelgue', 'Muse', 'Soda Stereo', 'Bandalos Chinos', 'Onda Vaga', 'Menudo', 'Tremendo', 'Red', 'Grupo Green', 'Adrian y los Dados Negros', 'The Nada'];

console.log('La banda en primer lugar es'+ bandas[0],
'La banda en tercer lugar es' + bandas[2],
'La banda en sexto lugar es' + bandas[5])